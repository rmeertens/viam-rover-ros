...
class ViamRobotController(Node):
    ...
    def odometry_update(self):
        ...
        # Publish a laserscan message to fool the navigation stack...
    ...
    def motor_control_callback(self):
        """Control the motors based on the last velocity message. """        
        if self.last_velocity != None:
            ...
            if left_motor_power != 0:
                ...
                self.get_logger().info(f"Now setting right motor power to {right_motor_power:.2f}")
